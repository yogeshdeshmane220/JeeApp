...
public class ChemistElevenAdapter extends RecyclerView.Adapter<ChemistElevenAdapter.MyviewHolder> {
    Context context;
    ArrayList<modelclass> topiclist;
    SelectItem selectItem;

    public ChemistElevenAdapter(Context context, ArrayList<modelclass> topiclist, SelectItem selectItem) {
    ...
    @NonNull
    @Override
    public ChemistElevenAdapter.MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.chemistlist,parent,false);
        return  new ChemistElevenAdapter.MyviewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ChemistElevenAdapter.MyviewHolder holder, int position) {

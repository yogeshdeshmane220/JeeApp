...
public class mathTwelveAdapter extends RecyclerView.Adapter<mathTwelveAdapter.MyviewHolder> {
    Context context;
    ArrayList<modelclass> topiclist;
    SelectItem selectItem;

    public mathTwelveAdapter(Context context, ArrayList<modelclass> topiclist, SelectItem selectItem) {
    ...
    @NonNull
    @Override
    public mathTwelveAdapter.MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.chemistlist,parent,false);
        return  new mathTwelveAdapter.MyviewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull mathTwelveAdapter.MyviewHolder holder, int position) {

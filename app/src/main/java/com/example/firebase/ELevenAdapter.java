...
public class ELevenAdapter extends RecyclerView.Adapter<ELevenAdapter.MyviewHolder> {
    Context context;
    ArrayList<modelclass> topiclist;
    SelectItem selectItem;

    public ELevenAdapter(Context context, ArrayList<modelclass> topiclist,SelectItem selectItem) {
    ...
    @NonNull
    @Override
    public ELevenAdapter.MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View v = LayoutInflater.from(context).inflate(R.layout.syllablist,parent,false);
       return  new MyviewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull ELevenAdapter.MyviewHolder holder, int position) {

...
public class mathElevenAdapter extends RecyclerView.Adapter<mathElevenAdapter.MyviewHolder> {
    Context context;
    ArrayList<modelclass> topiclist;
    SelectItem selectItem;

    public mathElevenAdapter(Context context, ArrayList<modelclass> topiclist, SelectItem selectItem) {
    ...
    @NonNull
    @Override
    public mathElevenAdapter.MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.chemistlist,parent,false);
        return  new mathElevenAdapter.MyviewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull mathElevenAdapter.MyviewHolder holder, int position) {
